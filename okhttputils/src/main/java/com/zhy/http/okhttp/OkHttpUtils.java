...
public class OkHttpUtils
{
    ...
    public OkHttpUtils(OkHttpClient okHttpClient)
    {
        if (okHttpClient == null)
        {
            ...
            okHttpClientBuilder.retryOnConnectionFailure(false); // 不在重发
            //cookie enabled/Users/chengxingjiang/Desktop/BmacNfcNew_20160802/okhttputils
...
//        builder.retryOnConnectionFailure(false);  // 不再重发
